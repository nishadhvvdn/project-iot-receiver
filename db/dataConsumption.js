    ...
    try {
        ...
        if (device.NoOfClients) {
            ...
            async.each(clientsArr, function (client, innercallback) {
                ...
                var HostnameQuery = "SELECT User_Hostname FROM deltamart.deltalink_clients_trending where User_Mac_Id='" + client.UserMacId + "' and Deltalink_ID='" + deltalinkId + "' and User_Hostname NOT IN ('*','') order by Actual_ReadTimestamp desc limit 1";
