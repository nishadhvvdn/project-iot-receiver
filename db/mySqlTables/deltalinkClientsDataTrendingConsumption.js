...
var objDeviceConsumption = {
    ...
    User_DataUploadDiff: { type: Sequelize.DECIMAL(20, 6) },
    User_DataDownloadDiff: { type: Sequelize.DECIMAL(20, 6) },
    User_TotalDiff: { type: Sequelize.DECIMAL(20, 6) }
}

var objTableProps = {
    timestamps: true,
    freezeTableName: true,
    tableName: 'deltalink_clients_trending'
}
